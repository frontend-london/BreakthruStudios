...
/*            var image = new Image ();
	      image.src = 'loading.php';
            image.imagesLoaded(function(){
	      alert('e');
	    });
  */          
            $('#loading-holder').load("_imagelist2.php",function(){

	      
	      
                $('#listLoad').imagesLoaded(function($images, $proper, $broken ){
		  //alert('d');
                    var scrolled = -1200;
                    var offset_left = 529-$('#slide1-pos').offset().left;
                    $('#parallax-bg5').css('left',(0-offset_left+(scrolled*0.50))+'px');
...
//                    alert("Thank you for your comment!"); 
                ...
                $('a.s4-arrows').click(function(event) {
                    ...
                    if(togggle_s4) {
                        ...
                        $('div#s4-films-b').hide();
                        $('div#s4-films-a').fadeIn('slow');    
                    }
                    togggle_s4 = !togggle_s4;
                });
                ...
                var fullscreenVideo = function(){
                    var myPlayer = this;
                    if(!video_play_counter) myPlayer.requestFullScreen();
